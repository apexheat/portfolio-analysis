...
export interface PortfolioAnalysisResult {
  ...
  DH_HEAT_RECOVERY_finance_impact_eur_m2_month: number;
  ...
  GS_finance_impact_eur_m2_month: number;
  GS_heating_eur_per_mwh: number;
  GS_heating_savings_eur: number;
  GS_hp_power: number;
  GS_hp_electricity_eur: number;
  GS_hp_electricity_eur_per_mwh: number;
  ...
  GS_HEAT_RECOVERY_finance_impact_eur_m2_month: number;
  GS_HEAT_RECOVERY_heating_eur_per_mwh: number;
  GS_HEAT_RECOVERY_heating_savings_eur: number;
  GS_HEAT_RECOVERY_hp_electricity_eur: number;
  GS_HEAT_RECOVERY_hp_electricity_eur_per_mwh: number;
